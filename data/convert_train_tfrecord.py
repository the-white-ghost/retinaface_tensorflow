"""
    ref: https://github.com/balancap/SSD-Tensorflow/blob/master/datasets/pascalvoc_to_tfrecords.py
    Naive data is converted to tfrecord as it makes it easier to mix and shuffle dataset to avoid biasing
    and the entire dataset is contained in a single file which is convinient.
